  ...
  return (
    <div className="flex justify-between items-center">
      <div className="flex gap-4">
        <img
          className="w-[83px] lg:w-[166px] h-[74px] lg:h-[148px] object-cover rounded-xl"
          src={cover_photo}
          alt="cover photo"
        />
      ...
      <Anchor
        to={"/chapter/" + _id + "/1"}
        className="w-[140px] h-[74px] flex justify-center items-center rounded-full font-bold text-[24px] text-white bg-gradient-to-r from-indigo-700 to-indigo-500"
      >
        Read
      </Anchor>
    </div>
