...
const AdminPanel = () => {
    ...
    return (
        <div className="flex flex-col items-center bg-slate-100">
            ...
            >
                <p className="-mt-[9%] text-[64px] text-white font-roboto font-medium">Panel</p>
            </div>
            <div className="relative -top-[174px] bg-white p-[20px] lg:p-[50px] w-[90%] flex flex-col justify-center items-center rounded-2xl">
                <p className="text-primary text-[32px] font-bold border-b-2 border-primary mb-6">Entities</p>
