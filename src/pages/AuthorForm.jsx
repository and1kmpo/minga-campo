      ...
      <main className=" flex w-full min-h-screen items-center justify-between overflow-x-hidden mb-6 font-roboto ">
        <div className="  flex flex-col  mt-[10%] md:mt-[14%] lg:mt-[10%] justify-center items-center  w-screen ">
          ...
          <div className="flex flex-col mt-8 gap-6">
            <input
              ref={name}
              className=" px-4 h-[50px] w-[300px] border-b hover:rounded-lg hover:border-rounded  hover:border-purple  "
              type="text"
              name="name"
              id="name"
              placeholder="Name"
          ...
          <input
            className="mt-10 w-[200px] lg:w-[250px]   h-[55px] lg:h-[68px]    font-bolder text-2xl text-gray-100 rounded-full bg-purple"
            type="button"
            value="Send"
            onClick={authorForm}
          />
