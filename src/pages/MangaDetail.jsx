  ...
  return (
    <div className="flex flex-col gap-6 font-poppins pt-[77px] pb-[30px] bg-[#EBEBEB]">
      <div id="div-title" className="flex flex-col items-center px-4 pt-2">
        <img
          className="rounded-xl w-full h-[40vh] lg:h-[60vh] object-cover object-top"
          src={manga?.cover_photo}
          alt="cover_photo"
        />
        <h1
          className={
            "text-[40px] font-normal " + (openTab === 1 ? "block" : "hidden")
          }
        >
          {manga?.title}
        </h1>
        ...
        >
          <span
            ...
            className="capitalize text-[12px] font-medium rounded-xl py-2 px-4"
          >
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:justify-around">
        <div
          id="div-emojis"
          className={
            "flex justify-center gap-2 " + (openTab === 1 ? "block" : "hidden")
          }
        >
        ...
        <div
          id="div-score"
          className={
            "flex flex-col items-center " + (openTab === 1 ? "block" : "hidden")
          }
        >
      ...
      <div id="tabs" className="px-4">
        <div
          id="t_names"
          className="flex flex-wrap mb-6 list-none border rounded-full shadow-[0px_0px_7px_2px_rgba(0,0,0,0.15)]"
        >
          <a
            className={
              "w-1/2 rounded-full py-2 lg:py-4 flex justify-center items-center " +
              (openTab === 1
            ...
            >
              ...
              <div className="flex flex-col items-center text-[12px] font-semibold">
                <div className="flex">
                  {prev && (
                    <button
                      className="p-2 rounded-l-lg font-bold text-white bg-gradient-to-r from-indigo-700 to-indigo-500"
                      value={prev}
                      onClick={(e) => {
                        link_page(e.target.value);
                      }}
                    >
                      Prev
                    </button>
                  ...
                  {next && (
                    <button
                      className="p-2 rounded-r-lg font-bold text-white bg-gradient-to-r from-indigo-500 to-indigo-700"
                      value={next}
                      onClick={(e) => {
                        link_page(e.target.value);
                      }}
