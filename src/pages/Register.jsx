...
import register_img from   "../assets/form_Ch.png"
        ...
        <main className='flex w-full min-h-screen items-center justify-between'>
            <div className="flex flex-col  md:top-0 md:right-[50%] justify-center items-center h-screen w-full md:w-[50%]">
                ...
                <form className="flex flex-col my-[25px]">
                    ...
                    <input onClick={register} className="w-[260px] md:w-[300px] lg:w-[360px] xl:w-[440px] h-[60px] p-2 my-[12px] text-xl text-white rounded-lg bg-orange" type="button" value="Register" />
                </form>
                <p className="font-semibold text-[12px] mt-[12px] text-center p-2">Already have an account? <Anchor to='/signin' className="text-orange">Log in</Anchor>!</p>
                <p className="font-semibold text-[12px] text-center p-2">Go back to <Anchor to='/' className="text-orange hover:text-black">Home</Anchor>!</p>
            </div>
            <img className="hidden md:block md:absolute md:top-0 md:right-0 h-screen w-[50%] object-cover" src={register_img}  alt="register" />
        </main>
    )
