  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-between items-center h-screen bg-gray-100">
        <Nav_2 />
        <div
          className="relative flex justify-center items-center  w-full   h-screen   mb-10    bg-contain bg-center bg-no-repeat "
        ...
        >
          <div className="flex  justify-between w-full  md:w-[90%] lg:w-[70%] xl:w-[52%] md:px-20 h-[90%] absolute ">
            <div
              className=" justify-start items-center  flex  xl:hover:bg-[#0000000a] w-[48%]  h-auto lg:mr-12 mr-8  md:mt-0   "
              onClick={prev}
            >
              <ArrowChapter d={d_left} />
            </div>
            <div
              className=" flex justify-end items-center xl:hover:bg-[#0000000a]  w-[48%]   h-auto  md:mt-0   "
              onClick={next}
            >
          ...
          <div className="  flex self-end  w-[80%] justify-center items-center -mb-9 md:-mb-10  ">
            <img
              className="md:h-9 md:w-10 mt-12 md:mt-8 "
              src={icon_comment}
              alt="comments"
            />
